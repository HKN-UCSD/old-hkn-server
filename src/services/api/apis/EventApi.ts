...
export class EventApi extends runtime.BaseAPI {
   ...
   */
  async eventControllerAffiliateEventRSVPRaw(
    requestParameters: EventControllerAffiliateEventRSVPRequest
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'eventID',
        'Required parameter requestParameters.eventID was null or undefined when calling eventControllerAffiliateEventRSVP.'
      );
    }
    ...
    const response = await this.request({
      path: `/api/events/{eventID}/rsvp/affiliate`.replace(
        `{${'eventID'}}`,
   ...
   * Affiliate event rsvp
   */
  async eventControllerAffiliateEventRSVP(
    requestParameters: EventControllerAffiliateEventRSVPRequest
  ): Promise<RSVPResponse> {
    const response = await this.eventControllerAffiliateEventRSVPRaw(
      requestParameters
    );
   ...
   */
  async eventControllerAffiliateEventSigninRaw(
    requestParameters: EventControllerAffiliateEventSigninRequest
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'eventID',
        'Required parameter requestParameters.eventID was null or undefined when calling eventControllerAffiliateEventSignin.'
      );
    }
    ...
    const response = await this.request({
      path: `/api/events/{eventID}/signin/affiliate`.replace(
        `{${'eventID'}}`,
        encodeURIComponent(String(requestParameters.eventID))
      ),
      method: 'POST',
   ...
   * Affiliate event signin
   */
  async eventControllerAffiliateEventSignin(
    requestParameters: EventControllerAffiliateEventSigninRequest
  ): Promise<AttendanceResponse> {
    const response = await this.eventControllerAffiliateEventSigninRaw(
      requestParameters
    );
    return await response.value();
  }
