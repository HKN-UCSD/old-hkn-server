...
export function EventAttendanceResponseFromJSON(json: any): EventAttendanceResponse {
    return EventAttendanceResponseFromJSONTyped(json, false);
}

export function EventAttendanceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventAttendanceResponse {
...
export function EventAttendanceResponseToJSON(value?: EventAttendanceResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
