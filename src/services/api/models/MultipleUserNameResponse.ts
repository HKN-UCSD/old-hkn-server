...
export function MultipleUserNameResponseFromJSON(json: any): MultipleUserNameResponse {
    return MultipleUserNameResponseFromJSONTyped(json, false);
}

export function MultipleUserNameResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultipleUserNameResponse {
...
export function MultipleUserNameResponseToJSON(value?: MultipleUserNameResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
