...
export function MultipleEventResponseFromJSON(
  json: any
): MultipleEventResponse {
  return MultipleEventResponseFromJSONTyped(json, false);
}

export function MultipleEventResponseFromJSONTyped(
  json: any,
...
export function MultipleEventResponseToJSON(
  value?: MultipleEventResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
